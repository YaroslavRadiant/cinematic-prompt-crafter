...
// const COLOR_PALETTES = ["Warm Tones", "Cool Tones", "Muted Colors", "Vibrant Colors", "Pastel Colors", "Monochromatic", "Complementary Colors", "Analogous Colors", "Triadic Colors"];
